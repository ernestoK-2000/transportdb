...
public class TablaSituacionConductor extends JDialog {
	boolean x = false;
	 ...
	 * Create the dialog.
	 */
	public TablaSituacionConductor() {
		setTitle("Situaciones de los Conductores");
		...
		final DefaultTableModel model = new DefaultTableModel();
		{
			...
			
			{
				...
				Object[] columns = {"DNI del Conductor", "Situacion"};
