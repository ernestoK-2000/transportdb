...
public class TablaSituacionChofer extends JDialog {
	...
	public TablaSituacionChofer() {
		...
		/////
		{
			...
			{
				lblNewLabel = new JLabel("Conductor DNI");
					...
					public void actionPerformed(ActionEvent arg0) {
						if(!(comboBox.getSelectedItem().toString() == ("Ninguno"))){
							if(!(textField.getText().toString().equals(""))){
									...
									model.addRow(row);
								}else JOptionPane.showMessageDialog(null, "Error. Por favor ingrese el DNI del conductor correctamente ");
				...
				btnNewButton_1.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						if(a>=0){
							...
							}else JOptionPane.showMessageDialog(null, "Error. Por favor elija una modificacion ");		
